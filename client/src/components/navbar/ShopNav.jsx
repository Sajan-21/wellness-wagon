              ...
              <div className="shrink absolute inset-y-0 right-0 flex items-center pr-2 gap-10 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  ...
                  >
                    ...
                    <MenuItem>
                      <div className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:outline-none sm:hidden">
                    ...
                    <MenuItem>
                      <div className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:outline-none">
                        <FontAwesomeIcon icon={faArrowRightFromBracket} /> Sign
                        Out
                      </div>
                    </MenuItem>
                  </MenuItems>
