...
const subCategories = [
  ...
  { name: 'Add address', href: '#', icon:<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="col-span-3">
                <div className='p-5 rounded-xl border'>
                  ...
                  {/* {activeContent === "Add address" && <AddAddress />}
