      ...
      <div className="mt-6 border-t border-gray-100">
        <dl className="divide-y divide-gray-100">
          ...
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{seller.company ? seller.company : "name not specified"}</dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            <dt className="text-sm/6 font-medium text-gray-900">Number of Products added</dt>
            <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{seller.added_Products ? (seller.added_products).length : "N/A"}
            </dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            <dt className="text-sm/6 font-medium text-gray-900">Total profit you got</dt>
            <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{seller.profit ? seller.profit : "N/A"}
            </dd>
          </div>
        </dl>
      </div>
