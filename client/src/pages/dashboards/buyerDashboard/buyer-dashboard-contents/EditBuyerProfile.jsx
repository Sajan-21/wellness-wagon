          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  type="number"
                  value={buyer.ph_number}
                  onChange={(e) =>
                    setBuyer({ ...buyer, ph_number: e.target.value })
                  }
                  className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                />
              </div>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  type="text"
                  value={buyer.house_name}
                  onChange={(e) =>
                    setBuyer({ ...buyer, house_name : e.target.value })
                  }
                  className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                />
              </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  type="text"
                  value={buyer.postal_area}
                  onChange={(e) =>
                    setBuyer({ ...buyer, postal_area: e.target.value })
                  }
                  className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                />
              </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  value={buyer.pincode}
                  onChange={(e) =>
                    setBuyer({ ...buyer, pincode: e.target.value })
                  }
                  className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                />
              </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  value={buyer.state}
                  onChange={(e) =>
                    setBuyer({ ...buyer, state: e.target.value })
                  }
                  className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                />
              </div>
