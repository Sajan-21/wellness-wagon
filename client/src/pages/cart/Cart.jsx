...
function Cart() {
  ...
  const handleProductOverview = (product_id) => {
    !isLoggedIn
      ...
      : navigate(
          `/product-overview/${params.auth_id}/${params.user_type}/${product_id}`
        );
  };
              ...
              <div className="flex flex-col space-y-3 text-xl">
                ...
                <span>
                  <Link
                    to={
                      params.auth_id
                        ? `/shop/${params.auth_id}/${params.user_type}`
                        : `/shop`
                    }
                  >
                    <button className="border border-black px-5 py-2 font-semibold hover:bg-slate-800 hover:border-0 hover:text-white">
                      SHOP NOW
                    </button>
                  </Link>
                </span>
                  ...
                  <div className="flex justify-between max-sm:flex-col max-sm:justify-between">
                    ...
                    <div className="px-5 pb-5 max-lg:flex max-lg:flex-col max-lg:items-center justify-between">
                      ...
                      <div className="max-lg:w-full text-end space-x-5 mt-2 flex items-center justify-between">
                        ...
                        <button
                          className="border px-5 py-3 rounded-2xl hover:border-red-500 hover:text-red-500"
                      ...
                      <div className="max-lg:w-full mt-3">
                        <button
                          ...
                          className="w-full border px-5 py-3 rounded-2xl hover:border-green-600 hover:text-green-600"
                        >
                          BUY NOW
                        </button>
                      </div>
        ...
        <div className="col-span-2 max-lg:col-span-6">
          <ul className="bg-white rounded-2xl p-2">
            <li className="flex gap-10 justify-between items-center w-3/4 mx-auto border-b pt-5 pb-2">
              ...
              <span>
                <FontAwesomeIcon icon={faIndianRupee} /> {totalProductsPrice}{" "}
              </span>
            </li>
            <li className="flex gap-10 justify-between items-center w-3/4 mx-auto border-b pt-5 pb-2">
              ...
              <span>
                <FontAwesomeIcon icon={faIndianRupee} />{" "}
                {totalProductsPrice -
                  Math.round((80 / 100) * totalProductsPrice)}{" "}
              </span>
            </li>
            <li className="flex gap-10 justify-between items-center w-3/4 mx-auto border-b pt-5 pb-2">
              <span>Shipping</span>
              <span>
                <FontAwesomeIcon icon={faIndianRupee} /> {products.length * 10}{" "}
              </span>
            </li>
            ...
            <li className="flex justify-center items-center  pt-5">
              <button
                ...
                onClick={() => {
                  if (!isLoggedIn) {
                    alert(
                      "You are not allowed to continue without login/sign-up"
                    );
                    return;
                  }
